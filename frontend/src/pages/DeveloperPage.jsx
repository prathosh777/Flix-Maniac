  ...
  return (
    <div className="bg-black  text-white">
      {user ? (
        <div>
          <Navbar />
          <div className="relative bg-black pt-28 text-white min-h-screen flex flex-col justify-between">
            <motion.div
        ...
        <div>
          ...
          <div className="relative bg-black pt-5 text-white min-h-screen flex flex-col justify-between">
            <motion.div
              className="flex-grow w-full  md:text-lg text-base mx-auto md:px-20 px-10 py-8"
              initial="hidden"
              animate="visible"
